...
const convertStateListToAbbreviations = (stateList) => {
  return stateList.map(stateName => stateNameToAbbreviation[stateName] || stateName);
};
...
const QuestionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      state: convertStateListToAbbreviations(formData.states),
    };
